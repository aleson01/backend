...
import {ListOrderTrueController } from './controllers/order/ListOrderTrueController'
...
router.get('/order/openOrder', isAuthenticated, new ListOrderTrueController().handle )
